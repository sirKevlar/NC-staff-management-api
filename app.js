...
const { postNewEvent } = require('./controllers/events.controllers');
const {
  getPdps,
  postNewPdp,
  getPdpById,
  patchPdpById,
} = require('./controllers/pdp.controllers');
const {
  getStaff,
  postNewStaff,
  getStaffById,
...
app.get('/api/pdps/:pdp_scheme', getPdpById);
app.patch('/api/pdps/:pdp_scheme', patchPdpById);
